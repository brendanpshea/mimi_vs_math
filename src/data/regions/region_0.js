const REGION = {
    ...
    levels: [
      ...
      },
      {
        ...
        weather: (camW, camH) => ({
          ...
          config: {
            ...
            speedX: { min: 55, max: 95 }, speedY: { min: 280, max: 420 },
            lifespan: 1800, quantity: 2, frequency: 45,
            alpha: { start: 0.30, end: 0 }, scale: { start: 0.9, end: 0.9 },
            tint: 0xBBDDFF, rotate: 12, gravityY: 0, maxParticles: 0,
          },
        }),
        bossUnlockKills: 4,
        enemySpawns: [
          ...
          { id: 'number_gnome' },
          { id: 'minus_mole' },
          { id: 'counting_caterpillar', topicOverride: 'addition', maxSum: 10 } // Spaced repetition review!
        ]
      },
      {
        id: '0-3',
      ...
      },
      {
        ...
        mathTopic: 'addSub',
        maxSum: 20,
        colorGrade: 0x445588, // Night time
        weather: null,
        isBossLevel: true,
        bossUnlockKills: 0,
        enemySpawns: []
